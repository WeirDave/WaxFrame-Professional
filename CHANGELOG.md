...
**Three small surgical changes — dark-mode "Send to Builder" label fix, retired satisfaction-indicator diagnostic, Dev Toolbar scene-flyout.** No behavioral impact on round flow, prompts, builder logic, or convergence. UI-only.
