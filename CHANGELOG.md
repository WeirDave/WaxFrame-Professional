...
- Icon catalog extended: LM Studio, Open WebUI, Together AI, and the internal gateway (the user's internal AI gateway) now match to local PNGs (`images/icon-lmstudio.png`, `images/icon-openwebui.png`, `images/icon-together.png`, `images/icon-gateway.png`).
