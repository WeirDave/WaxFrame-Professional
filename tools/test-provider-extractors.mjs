...
// The pre-v3.63.497 blind spot: this response HAS a conflicts block, so the
...
// v3.63.497 — the budget now comes from the model, not a constant. With no
...
// ── Requested output budget (v3.63.497) ─────────────────────────────
