...
// The pre-v3.63.495 blind spot: this response HAS a conflicts block, so the
...
// v3.63.495 — the budget now comes from the model, not a constant. With no
...
// ── Requested output budget (v3.63.495) ─────────────────────────────
