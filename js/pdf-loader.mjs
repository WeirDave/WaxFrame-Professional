...
//
//  v3.63.393 — Caught the dynamic-import failure path. The
...
//  the module loader). Pre-v3.63.393 this failed silently:
...
try {
  const pdfjsLib = await import("../lib/pdf.min.mjs?v=3.63.537");
