...
(function (root) {
  ...
  // ── Output budget resolution (v3.63.499) ──────────────────────────
  //
  ...
  // that looks finished, it just stops. Before v3.63.499 the only way to
  ...
  // WaxFrame speaks. Verified against live provider docs in v3.63.499:
  ...
  //
  // Values confirmed against provider docs in v3.63.499:
  ...
  // ── Forced-truncation test hook (v3.63.499) ───────────────────────
  //
  ...
  // v3.63.499 — generalised from the v3.63.489 force-truncate hook into a
  ...
  var BODY_BUILDERS = {
    'openai-chat': function (model, prompt) {
      ...
      // v3.63.499 — was deliberately omitted so the provider default would
  ...
  // ── What did we actually ask for? (v3.63.499) ─────────────────────
  //
  ...
  // ── Budget-rejection parsing (v3.63.499) ──────────────────────────
  //
  ...
  // v3.63.499 — `limitsOut` is an optional caller-owned object that gets
  ...
  root.WFProviderCatalog = {
    CATALOG: CATALOG,
    // v3.63.499 — exported so the custom/rehydrated anthropic-format body
