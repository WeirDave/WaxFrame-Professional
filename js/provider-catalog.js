...
(function (root) {
  ...
  // ── Output budget resolution (v3.63.498) ──────────────────────────
  //
  ...
  // that looks finished, it just stops. Before v3.63.498 the only way to
  ...
  // WaxFrame speaks. Verified against live provider docs in v3.63.498:
  ...
  //
  // Values confirmed against provider docs in v3.63.498:
  ...
  // ── Forced-truncation test hook (v3.63.498) ───────────────────────
  //
  ...
  // v3.63.498 — generalised from the v3.63.489 force-truncate hook into a
  ...
  var BODY_BUILDERS = {
    'openai-chat': function (model, prompt) {
      ...
      // v3.63.498 — was deliberately omitted so the provider default would
  ...
  // ── What did we actually ask for? (v3.63.498) ─────────────────────
  //
  ...
  // ── Budget-rejection parsing (v3.63.498) ──────────────────────────
  //
  ...
  // v3.63.498 — `limitsOut` is an optional caller-owned object that gets
  ...
  root.WFProviderCatalog = {
    CATALOG: CATALOG,
    // v3.63.498 — exported so the custom/rehydrated anthropic-format body
