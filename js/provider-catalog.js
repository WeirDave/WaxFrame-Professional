...
(function (root) {
  ...
  // ── Output budget resolution (v3.63.497) ──────────────────────────
  //
  ...
  // ── Truncation detection (v3.63.497) ──────────────────────────────
  //
  ...
  // that looks finished, it just stops. Before v3.63.497 the only way to
  ...
  // WaxFrame speaks. Verified against live provider docs in v3.63.497:
  ...
  //
  // Values confirmed against provider docs in v3.63.497:
  ...
  // ── Forced-truncation test hook (v3.63.497) ───────────────────────
  //
  ...
  // v3.63.497 — generalised from the v3.63.489 force-truncate hook into a
  ...
  var BODY_BUILDERS = {
    'openai-chat': function (model, prompt) {
      ...
      // v3.63.497 — was deliberately omitted so the provider default would
  ...
  // ── What did we actually ask for? (v3.63.497) ─────────────────────
  //
  ...
  // ── Budget-rejection parsing (v3.63.497) ──────────────────────────
  //
  ...
  // ── Observed-cap analysis (v3.63.497) ─────────────────────────────
  //
  ...
  // v3.63.497 — `limitsOut` is an optional caller-owned object that gets
  ...
  root.WFProviderCatalog = {
    CATALOG: CATALOG,
    // v3.63.497 — exported so the custom/rehydrated anthropic-format body
