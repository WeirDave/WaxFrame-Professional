...
(function (root) {
  ...
  // ── Output budget resolution (v3.63.500) ──────────────────────────
  //
  ...
  // ── Truncation detection (v3.63.500) ──────────────────────────────
  //
  ...
  // that looks finished, it just stops. Before v3.63.500 the only way to
  ...
  // WaxFrame speaks. Verified against live provider docs in v3.63.500:
  ...
  //
  // Values confirmed against provider docs in v3.63.500:
  ...
  // ── Forced-truncation test hook (v3.63.500) ───────────────────────
  //
  ...
  // v3.63.500 — generalised from the v3.63.489 force-truncate hook into a
  ...
  var BODY_BUILDERS = {
    'openai-chat': function (model, prompt) {
      ...
      // v3.63.500 — was deliberately omitted so the provider default would
      ...
      // v3.63.500 — stream when the caller asked for it. stream_options
  ...
  // custom/local server AI (Ollama, LM Studio, Open WebUI, the internal gateway). A full
  ...
  // ── What did we actually ask for? (v3.63.500) ─────────────────────
  //
  ...
  // ── Budget-rejection parsing (v3.63.500) ──────────────────────────
  //
  ...
  // ── Observed-cap analysis (v3.63.500) ─────────────────────────────
  //
  ...
  // v3.63.500 — `limitsOut` is an optional caller-owned object that gets
  ...
  //   • Honors an explicit modelsEndpoint override (Open WebUI / the internal gateway
  ...
  root.WFProviderCatalog = {
    CATALOG: CATALOG,
    // v3.63.500 — exported so the custom/rehydrated anthropic-format body
