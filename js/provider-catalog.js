...
(function (root) {
  ...
  // ── Output budget resolution (v3.63.503) ──────────────────────────
  //
  ...
  // ── Truncation detection (v3.63.503) ──────────────────────────────
  //
  ...
  // that looks finished, it just stops. Before v3.63.503 the only way to
  ...
  // WaxFrame speaks. Verified against live provider docs in v3.63.503:
  ...
  //
  // Values confirmed against provider docs in v3.63.503:
  ...
  // ── Forced-truncation test hook (v3.63.503) ───────────────────────
  //
  ...
  // v3.63.503 — generalised from the v3.63.489 force-truncate hook into a
  ...
  var BODY_BUILDERS = {
    'openai-chat': function (model, prompt) {
      ...
      // v3.63.503 — was deliberately omitted so the provider default would
      ...
      // v3.63.503 — stream when the caller asked for it. stream_options
  ...
  // ── What did we actually ask for? (v3.63.503) ─────────────────────
  //
  ...
  // ── Budget-rejection parsing (v3.63.503) ──────────────────────────
  //
  ...
  // ── Observed-cap analysis (v3.63.503) ─────────────────────────────
  //
  ...
  // v3.63.503 — `limitsOut` is an optional caller-owned object that gets
  ...
  root.WFProviderCatalog = {
    CATALOG: CATALOG,
    // v3.63.503 — exported so the custom/rehydrated anthropic-format body
