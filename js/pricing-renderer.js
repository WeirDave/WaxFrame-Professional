...
(function(){
  ...
  var FALLBACK_DATA = {
    lastUpdated: '2026-08-01T19:25:30Z',
    schemaVersion: 2,
    tokensPerRound: { input: 5000, output: 2000 },
    providers: [
      { id:'gemini-free', name:'Gemini (Google) — free tier', shortName:'Gemini Flash (free tier)', model:'gemini-3.5-flash', inputPerM:0.00, outputPerM:0.00, contextWindow:'1M', maxOutput:'8K', estPerRound:0.000, estNote:'free while AI Studio billing is disabled', billingUrl:'https://aistudio.google.com/api-keys', tier1Rpm:'15', tier1Tpm:'—', freeTier:'1500 RPD', rateLimitNotes:'Free while billing disabled. Daily quota resets at midnight Pacific.', recommendationTag:'cheapest', recommendationNote:'Free while AI Studio billing is disabled. 1M-token context window, 1500 requests/day quota, synthesizes Builder output reliably. Catch: enable billing on AI Studio and routing can quietly flip to paid tier on the same model name.' },
      { id:'gemini-paid', name:'Gemini (Google) — paid', shortName:'Gemini Flash (paid)', model:'gemini-3.5-flash', inputPerM:0.075, outputPerM:0.30, contextWindow:'1M', maxOutput:'8K', estPerRound:0.001, billingUrl:'https://aistudio.google.com/api-keys', tier1Rpm:'2K', tier1Tpm:'4M', freeTier:'n/a', rateLimitNotes:'Paid-tier limits are very generous; cost discipline matters more than RPM.', recommendationTag:null, recommendationNote:null },
      ...
      { id:'together', name:'Together AI', shortName:'Together AI', model:'Llama-3.3-70B-Instruct-Turbo', inputPerM:0.88, outputPerM:0.88, contextWindow:'128K', maxOutput:'4K', estPerRound:0.006, billingUrl:'https://api.together.ai/settings/organization/~current/billing', tier1Rpm:'~600', tier1Tpm:'varies', freeTier:'Trial credits', rateLimitNotes:'Open-weight model gateway; generous limits, not yet hive-tested in production.', recommendationTag:null, recommendationNote:null },
