  ...
  // ============================================================
  {
    ...
    "pathContent": {
      "refine": {
        ...
        "refMaterial": "═══════════════════════════════════════════════════════════════\nMULTI-PLATFORM REVIEW SPLITTING DIRECTIVE  (read every round)\n═══════════════════════════════════════════════════════════════\n\nThis project takes ONE detailed source review (provided as the Starting\nDocument) and produces THREE platform-ready versions of it. Every round,\nevery reviewer should evaluate ALL THREE sections of the working document\nand offer revisions that maintain the per-platform format and length\nwhile improving clarity, tone, and faithfulness to the source.\n\nThe three required platform versions:\n\n  1. TRIPADVISOR  — detailed narrative review, 500–900 words.\n                    Travel-context tone. Full experience arc.\n\n  2. GOOGLE MAPS  — concise practical review, 750–1,200 characters.\n                    Skim-friendly. Lead with the bottom line.\n\n  3. YELP         — conversational personality-forward review,\n                    300–700 words. First-person voice, no corporate polish.\n\nAll three versions must preserve the SAME facts and SAME final\nrecommendation from the source review. Do not invent details that\naren't in the source. Do not let one version drift in factual content\nfrom the others.\n\nIf the working document does not yet contain all three clearly labeled\nsections, your first job as a reviewer is to flag that the split is\nmissing — the Builder will produce the three sections on the next round.\n═══════════════════════════════════════════════════════════════\n\n[PASTE YOUR ORIGINAL SOURCE REVIEW BELOW — the detailed review you\nproduced from a Restaurant / Hotel / Business-Service template. This\nis the source of truth for every fact in all three platform versions.]\n\n",
        "lengthMode": "none",
        "lengthLimit": "",
        "lengthUnit": "",
        "hint": [
